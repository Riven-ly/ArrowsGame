...
public class Guide5Panel : UIBase
{
    ...
    public override void Refresh(object data = null)
    {
        ...
        GameObject obj = UIManager.Instance.GetUI<GameScenePanel>().snakeGameController.GetWayBlockerGameObject(0);
        if(obj == null)
        {
            Hide();
        }
        ...
        {
            PlayerPrefs.SetString("Guide5Panel", "yes");
            OtherSdkManager.Instance.CustomEvent("game_guide5");
            Hide();
        });
